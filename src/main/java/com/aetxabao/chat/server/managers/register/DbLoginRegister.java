...
import static com.aetxabao.chat.server.consts.AppConsts.DB_PST_INSERT_LOGIN;

public class DbLoginRegister implements IRegister<Record> {
    public void save(Record record) throws SQLException {
        String sql = DB_PST_INSERT_LOGIN;
